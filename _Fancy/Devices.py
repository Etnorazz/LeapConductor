...
OPR_BOB = ('A Coarse', 'B Level', 'B Coarse', 'B Fine', 'Filter Freq', 'Filter Res', 'Time', 'Tone')
...
ALG_BOB = ('F1 Freq', 'F1 Resonance', 'OSC1 Octave', 'Vib On/Off', 'AEG1 Attack', 'AEG1 Rel', 'Unison On/Off', 'Volume')
...
ELC_BANK5 = ('Volume', 'Polyphony', 'Semitone', 'Detune', 'KB Stretch', 'PB Range', '', '')
ELC_BOB = ('M Stiffness', 'M Force', 'Noise Amount', 'F Tine Vol', 'F Tone Vol', 'F Release', 'Damp Amount', 'Volume')
...
TNS_BOB = ('Excitator Type', 'E Pos', 'String Decay', 'Str Damping', 'Vib Amount', 'Filter Freq', 'Filter Reso', 'Volume')
...
COL_BOB = ('Res 1 Decay', 'Res 1 Material', 'Res 1 Brightness', 'Res 1 Inharmonics', 'Res 1 Type', 'Res 1 Tune', 'Mallet Stiffness', 'Volume')
...
NTL_BANK1 = ('Sync On', 'Time Length', 'Synced Length', 'Gate', 'Vel./Rel.Vel', 'Decay Time', 'Decay Key Scale', '')
NTL_BANKS = (NTL_BANK1,)
NTL_BOBS = (NTL_BANK1,)
...
CHR_BANKS = (CHR_BANK1,)
CHR_BOBS = (CHR_BANK1,)
CP3_BANK1 = ('Threshold', 'Ratio', 'Attack', 'Release', 'Knee', 'EF Mode', 'LookAhead', 'Model')
CP3_BANK2 = ('Ext. In On', 'Ext. In Gain', 'Ext. In Mix', 'Side Listen', 'EQ On', 'EQ Freq', 'EQ Q', 'EQ Mode')
CP3_BANK3 = ('EQ Gain', 'Makeup Gain', 'Output Gain', '', '', '', '', '')
CP3_BOB = ('Threshold', 'Ratio', 'Attack', 'Release', 'Ext. In Gain', 'Ext. In Mix', 'EQ Freq', 'Output Gain')
CP3_BANKS = (CP3_BANK1, CP3_BANK2, CP3_BANK3)
CP3_BOBS = (CP3_BOB,)
CP3_BNK_NAMES = ('Compression', 'Side Chain', 'Output')
CRP_BANK1 = ('Decay', 'Material', 'Mid Freq', 'Width', 'Bleed', '', 'Gain', 'Dry Wet')
...
CRP_BOB = ('Decay', 'Material', 'Brightness', 'Inharmonics', 'Resonance Type', 'Tune', 'Gain', 'Dry Wet')
CRP_BANKS = (CRP_BANK1, CRP_BANK2, CRP_BANK3)
CRP_BOBS = (CRP_BOB,)
CRP_BNK_NAMES = ('', '', '')
DTB_BANK1 = ('Dry/Wet', 'Output', 'Drive', 'Tone', 'Bias', 'Envelope', 'Attack', 'Release')
DTB_BANKS = (DTB_BANK1,)
DTB_BOBS = (DTB_BANK1,)
...
MBD_BOB = ('Below Threshold (Low)', 'Below Ratio (Low)', 'Below Threshold (Mid)', 'Below Ratio (Mid)', 'Below Threshold (High)', 'Below Ratio (High)', 'Master Output', 'Amount')
MBD_BANKS = (MBD_BANK1, MBD_BANK2, MBD_BANK3, MBD_BANK4, MBD_BANK5)
MBD_BOBS = (MBD_BOB,)
MBD_BNK_NAMES = ('Global', 'Low Band', 'Mid Band', 'High Band', 'Split Frequencies')
OVR_BANK1 = ('Filter Freq', 'Filter Width', 'Drive', 'Tone', 'Dry/Wet', 'Preserve Dynamics', '', '')
OVR_BANKS = (OVR_BANK1,)
OVR_BOBS = (OVR_BANK1,)
PHS_BANK1 = ('Poles', 'Color', 'Dry/Wet', 'Frequency', 'Env. Modulation', 'Env. Attack', 'Env. Release', 'Feedback')
PHS_BANK2 = ('LFO Amount', 'LFO Frequency', 'LFO Phase', 'LFO Sync', 'LFO Offset', 'LFO Synced Rate', 'LFO Spin', 'LFO Waveform')
...
AMP_BANK1 = ('Gain', 'Bass', 'Middle', 'Treble', 'Presence', 'Volume', 'Dry/Wet', 'Amp Type')
AMP_BANK2 = ('Dual Mono', '', '', '', '', '', '', '')
...
def number_of_parameter_banks(device):
    ...
    if device != None:
        ...
        if device.class_name in DEVICE_DICT.keys():
            ...
            param_count = len(list(device.parameters[1:]))
