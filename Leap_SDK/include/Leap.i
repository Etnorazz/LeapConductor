...
#   swig -c++ -java   -o Leap_wrap_java.cpp                          Leap.i
#   swig -c++ -csharp -o Leap_wrap_csharp.cpp -dllimport _LeapCSharp Leap.i
...
#if defined(_WIN32)
#include <windows.h>
// When dynamically loading the Leap C# DLL, set the DLL search path to look
// in the same the directory. This will allow loading the Leap.dll.
